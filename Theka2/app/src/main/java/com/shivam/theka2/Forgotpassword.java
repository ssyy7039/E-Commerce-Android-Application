...
public class Forgotpassword extends AppCompatActivity {
                ...
                if(Email.isEmpty()){
                    ...
                    firebaseAuth.sendPasswordResetEmail(Email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(com.shivam.theka2.Forgotpassword.this, "Password reset email has been sent", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(com.shivam.theka2.Forgotpassword.this,Signin.class));
                        }
                    });
                }
            }
    ...
    public void checkConnection(){
        ...
        View view=findViewById(R.id.forgotpasswordsnackbar);
