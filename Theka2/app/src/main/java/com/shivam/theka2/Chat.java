...
public class Chat extends AppCompatActivity {
    ...
    String Name,Chat,Contact,Email;
    @Override
...
//        });
        ...
        email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String recipient="kicktheli6@gmail.com";
                String subject=Name+"\t\tHas a query,"+"\n"+Contact+"\t\t"+Email;
             ...
             //   intent.putExtra(Intent.EXTRA_TEXT,message);
                try {
                 ...
                 //   Toast.makeText(Chat.this, "Sending....", Toast.LENGTH_SHORT).show();
                    ...
                    checkConnection();
                    Toast.makeText(com.shivam.theka2.Chat.this,e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.shivam.theka2.Feedbackdata feedbackdata = new com.shivam.theka2.Feedbackdata(Chat,Name,Contact,Email,uid,myCurrentDateTime);

                FirebaseDatabase.getInstance().getReference("FeedBacks").child("Customers")
                        .child(Contact).child(myCurrentDateTime).setValue(feedbackdata).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(com.shivam.theka2.Chat.this, "Thanks for the Feedback. we will get back to you soon!", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(com.shivam.theka2.Chat.this, "Feedback did not submit at this time", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public void checkConnection(){
        ...
        View view=findViewById(R.id.chatsnakbar);
