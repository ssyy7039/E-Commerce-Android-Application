...
public class Otp extends AppCompatActivity {
    EditText otp;
    Button verify;
    private String mVerificationId,Name,Contact,Emailid,Password,Address;
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(com.shivam.theka2.Otp.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(com.shivam.theka2.Otp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            //verification successful we will start the profile activity
                            sendUserData1();
                            Intent intent = new Intent(com.shivam.theka2.Otp.this, com.shivam.theka2.MainActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                            finish();
                            Toast.makeText(Otp.this, "You are successfully logged in ", Toast.LENGTH_SHORT).show();
...
//                            snackbar.show();
    ...
    public void sendUserData1(){
        ...
        customerdata customerdata = new customerdata(Name,Contact,Emailid,Address);
FirebaseAuth firebaseAuth=FirebaseAuth.getInstance();
        ...
        FirebaseDatabase.getInstance().getReference("All Customers")
            ...
            public void onFailure(@NonNull Exception e) {
                checkConnection();
                Toast.makeText(com.shivam.theka2.Otp.this, "Registeration failed", Toast.LENGTH_SHORT).show();
            }
        });
