    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  password=findViewById(R.id.PASSWORD);
       ...
       firebaseUser=firebaseAuth.getCurrentUser();
        ...
        final DatabaseReference databaseReference=firebaseDatabase.getReference("All Customers").child(uid).child("profile");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    customerdata registeredData = dataSnapshot.getValue(customerdata.class);
                    name.setText(registeredData.getName());
                    email.setText(registeredData.getEmail());
                  CONTACT= registeredData.getContactNo();
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(com.shivam.theka2.Updatedetails.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(com.example.theka2.Updatedetails.this, "Password changed", Toast.LENGTH_SHORT).show();
//                    finish();
//                }else {
//                    Toast.makeText(com.example.theka2.Updatedetails.this, "Password is not updated", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
...
//            public void onComplete(@NonNull Task<Void> task) {
//                if (task.isSuccessful()){
//                    Toast.makeText(com.example.theka2.Updatedetails.this, "Email is Changed", Toast.LENGTH_SHORT).show();
//                    finish();
//                }else{
//                    Toast.makeText(com.example.theka2.Updatedetails.this, "Email is not updated", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });

        customerdata registeredData=new customerdata(NAME,CONTACT,EMAIL,ADDRESS);
        databaseReference.setValue(registeredData);

        finish();
        Toast.makeText(com.shivam.theka2.Updatedetails.this, "Your profile data updated", Toast.LENGTH_SHORT).show();
    }
});
