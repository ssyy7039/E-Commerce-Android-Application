...
//        });
        ...
        email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkConnection();
                    Toast.makeText(com.shivam.shop.Chat.this,e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.shivam.shop.Feedbackdata feedbackdata = new com.shivam.shop.Feedbackdata(Chat,Shopname,Contact,Email,uid,myCurrentDateTime);
                ...
                FirebaseDatabase.getInstance().getReference("FeedBacks").child("Owners")
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(com.shivam.shop.Chat.this, "Thanks for the Feedback. we will get back to you soon!", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(com.shivam.shop.Chat.this, "Feedback did not submit at this time", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
