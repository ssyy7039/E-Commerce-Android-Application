...
Button share;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.shivam.shop.Profile.this,Myaccount.class));
            }
        });
        ...
        orders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.shivam.shop.Profile.this,Allorders.class));
            }
        });
        findViewById(R.id.info).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.shivam.shop.Profile.this,Appinfo.class));
            }
        });
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(firebaseUser!=null){
                    ...
                    Intent intent=new Intent(com.shivam.shop.Profile.this, Signin.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    Toast.makeText(com.shivam.shop.Profile.this, "You are successfully logged out", Toast.LENGTH_SHORT).show();
