...
public class Updatedetails extends AppCompatActivity {
    EditText name,contact,password,shopname,gst,address;
    Button submit;
    String NAME,CONTACT,EMAIL,PASSWORD,SHOPNAME,GST,ADDRESS,Key;
       ...
       firebaseUser=firebaseAuth.getCurrentUser();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(com.shivam.shop.Updatedetails.this, databaseError.getCode(), Toast.LENGTH_SHORT).show();
        ...
        firebaseUser.updatePassword(PASSWORD).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                  //  Toast.makeText(com.example.shop.Updatedetails.this, "Password changed", Toast.LENGTH_SHORT).show();
                    finish();
                }else {
                   // Toast.makeText(com.example.shop.Updatedetails.this, "Password is not updated", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//            public void onComplete(@NonNull Task<Void> task) {
//                if (task.isSuccessful()){
//                  //  Toast.makeText(com.example.shop.Updatedetails.this, "Email is ", Toast.LENGTH_SHORT).show();
//                    finish();
//                }else{
//                   // Toast.makeText(com.example.shop.Updatedetails.this, "Email is not updated", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
        com.shivam.shop.RegisteredData registeredData=new com.shivam.shop.RegisteredData(NAME,CONTACT,EMAIL,PASSWORD,SHOPNAME,GST,ADDRESS,Key);
        databaseReference.setValue(registeredData);
        DatabaseReference databaseReference2=firebaseDatabase.getReference("All Owners");
        databaseReference2.child(Key).setValue(registeredData);
        finish();
        Toast.makeText(com.shivam.shop.Updatedetails.this, "Your profile data updated", Toast.LENGTH_SHORT).show();
    }
});
    }
