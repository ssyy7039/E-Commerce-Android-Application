...
public class Drinkadapter extends RecyclerView.Adapter<DrinkViewHolder> {
    ...
    @Override
    public com.shivam.shop.DrinkViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.carddrink,parent,false);


        return  new com.shivam.shop.DrinkViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final com.shivam.shop.DrinkViewHolder holder, int position) {
        Glide.with(context)
