...
public class Drinkdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Drinkdetails.this, Updatedrink.class)
                        ...
                        .putExtra("key", key)
                        .putExtra("Size", size.getText().toString())
    ...
    public void Dialog() {
        ...
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                checkConnection();
                final ProgressDialog progressDialog = new ProgressDialog(Drinkdetails.this);
                ...
                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(Drinkdetails.this, "Your Drink Successfully Deleted ", Toast.LENGTH_SHORT).show();
