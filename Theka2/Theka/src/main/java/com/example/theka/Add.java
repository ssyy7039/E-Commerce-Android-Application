...
public class Add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(com.shivam.theka.Add.this);
        ...
        Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (uri == null) {
                    Toast.makeText(com.shivam.theka.Add.this, "Please Upload drink Image", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (Prize.isEmpty()) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference("Owners").child(uid)
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(com.shivam.theka.Add.this, "Drink Uploaded", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(com.shivam.theka.Add.this, "uploading of the Drink is Failed", Toast.LENGTH_SHORT).show();
                    }
                });
